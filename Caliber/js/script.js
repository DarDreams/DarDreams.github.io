...
window.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        team1Selector[1].children[4].insertAdjacentHTML('afterbegin',`<svg class="skill-ico"><title>test</title><use xlink:href="#${game.team1.assault.perks.split(",")[i]}"></use></svg>`);
        team1Selector[2].children[4].insertAdjacentHTML('afterbegin',`<svg class="skill-ico"><use xlink:href="#${game.team1.gunner.perks.split(",")[i]}"></use></svg>`);
        team1Selector[3].children[4].insertAdjacentHTML('afterbegin',`<svg class="skill-ico"><use xlink:href="#${game.team1.medic.perks.split(",")[i]}"></use></svg>`);
        team1Selector[4].children[4].insertAdjacentHTML('afterbegin',`<svg class="skill-ico"><use xlink:href="#${game.team1.sniper.perks.split(",")[i]}"></use></svg>`);
    }
